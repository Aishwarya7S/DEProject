...
import Hazardhunt from "../Assets/Hazardhunt.webp";
import Mindmaze from "../Assets/Mindmaze.webp";
import Canvas from "../Assets/Canvas.webp";
import Patternpuzzle from "../Assets/Patternpuzzle.webp";
  ...
  return (
    <div className="game-container">
      ...
      <div className="games-list">
        ...
        {/* Back Button for unauthenticated users */}
        {/* {!isAuthenticated && (
