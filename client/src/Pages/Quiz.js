...
import LegalRights from "../Assets/Legalrights.avif";
import ChildrenRights from "../Assets/Childrenrights.png";
                      ...
                      <Row className="mt-3">
                        {currentQuiz.questions[currentQuestion].options.map((option, index) => (
                          <Col key={index} md={6} className="mb-2">
                            <Button variant={selectedOption === index ? "warning" : "outline-primary"} className="w-100 d-flex align-items-center justify-content-start option-button" onClick={() => setSelectedOption(index)}>
                              <span className="badge badge-pill text-white me-2" style={{ backgroundColor: "black", minWidth: "30px", textAlign: "center" }}>{String.fromCharCode(65 + index)}</span>
