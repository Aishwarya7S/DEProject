...
import { FaPhoneAlt, FaHospital, FaUserShield, FaHeartbeat, FaArrowAltCircleUp, FaSearch } from "react-icons/fa";
...
const icons = [
  ...
  { icon: MdEmergency, color: "#0000FF" },
  { icon: FaHeartbeat, color: "#fd0628" },
  { icon: MdHealthAndSafety, color: "#f24b16" },
];
const resourcesData = {
  legalHelp: [
    {
    ...
    {
      name: "Women's and Children's Rights",
  ...
  helplines: [
    ...
    { name: "National Citizen Emergency Helpline (All-in-One Helpline)", number: "112" },
