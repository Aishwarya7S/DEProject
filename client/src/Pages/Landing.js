...
const features = [
  ...
  { icon: <FaUser Md />, title: "Counselling Support", description: "Providing professional mental health and safety guidance." },
    ...
    <>
      ...
      <div className="key-container">
        ...
        <style jsx>{`
          .home-container {
            padding: 50px;
            background: linear-gradient(135deg, rgb(152, 18, 18), rgb(134, 31, 162), rgb(112, 4, 53));
            color: white;
            min-height: 100vh;
            display: flex;
            align-items: center;
